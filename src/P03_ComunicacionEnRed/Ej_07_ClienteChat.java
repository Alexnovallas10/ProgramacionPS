...
public class Ej_07_ClienteChat extends JFrame implements ActionListener, Runnable {
	...
	// constructor
	public Ej_07_ClienteChat(Socket s, String nombre) {
	...
	public static void main(String args[]) {
		...
		try {
			...
			Ej_07_ClienteChat cliente = new Ej_07_ClienteChat(s, nombre);
