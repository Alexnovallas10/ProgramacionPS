...
public class clienteFicheros extends JFrame implements Runnable {
		...
		botonDescargar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {				
				...
				try {
					...
					// reciba. 
					FileOutputStream fos = new FileOutputStream("P04_ServidorFicheros\\Ej_01_ServidorFichero\\Descargas\\"+ficheroSelec);
	...
	public static void main(String[] args) throws IOException {
		...
		//Para enviar a otros equipos de la red
		//Socket s = new Socket("192.168.7.22", puerto);		
